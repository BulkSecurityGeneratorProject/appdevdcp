...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(br.com.lasa.dcpdesconformidades.domain.Avaliador.class.getName() + ".avaliacaos", jcacheConfiguration);
            ...
            cm.createCache(br.com.lasa.dcpdesconformidades.domain.Avaliacao.class.getName() + ".itemAvaliados", jcacheConfiguration);
            ...
            cm.createCache(br.com.lasa.dcpdesconformidades.domain.ItemAvaliacao.class.getName() + ".itemAvaliados", jcacheConfiguration);
