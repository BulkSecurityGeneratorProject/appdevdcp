...
public class GrupoItensDTO implements Serializable {
  ...
  private LinkedHashSet<ItemAvaliacaoDTO> itens = new LinkedHashSet<>();
  ...
  public LinkedHashSet<ItemAvaliacaoDTO> getItens() {
    return itens;
  }

  public void setItens(LinkedHashSet<ItemAvaliacaoDTO> itemAvaliacaos) {
  ...
  public String toString() {
    return "GrupoItensDTO{" + "id=" + getId() + ", nome='" + getNome() + "'" + ", questionario=" + getQuestionarioId() + ", questionario='" + getQuestionarioNome() + "'" + "}";
  }
