...
describe('ItemAvaliado e2e test', () => {
  ...
  /* it('should create and save ItemAvaliados', async () => {
        ...
        await itemAvaliadoUpdatePage.setPontosProcedimentoInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosProcedimentoInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosPessoaInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosPessoaInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosProcessoInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosProcessoInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosProdutoInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosProdutoInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosObtidosProcedimentoInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosObtidosProcedimentoInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosObtidosPessoaInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosObtidosPessoaInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosObtidosProcessoInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosObtidosProcessoInput()).to.eq('5');
        await itemAvaliadoUpdatePage.setPontosObtidosProdutoInput('5');
        expect(await itemAvaliadoUpdatePage.getPontosObtidosProdutoInput()).to.eq('5');
  ...
  /* it('should delete last ItemAvaliado', async () => {
        ...
        expect(await itemAvaliadoDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/dcpdesconformidadesApp.itemAvaliado.delete.question/);
