...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_LOJA_LIST), REQUEST(ACTION_TYPES.FETCH_LOJA)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_LOJA),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should create/update entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.CREATE_LOJA),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_LOJA actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_LOJA)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_LOJA),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.CREATE_LOJA actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.CREATE_LOJA)
        },
        {
          type: SUCCESS(ACTION_TYPES.CREATE_LOJA),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.UPDATE_LOJA actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.UPDATE_LOJA)
        },
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_LOJA),
          payload: resolvedObject
        },
        {
          type: REQUEST(ACTION_TYPES.FETCH_LOJA_LIST)
